...
<div class="row no-gutters mt-5">
    ...
    <div class="col-md-10 p-5 pr-2">
        <h3><i class="bi bi-menu-up mr-2"></i>DAFTAR GALERI</h3>

        <hr>
        <a href="/Admin/Galeri/tambah" class="btn btn-primary mb-3"><i class="bi bi-plus-square-fill mr-2"></i>Tambah data Galeri</a>
